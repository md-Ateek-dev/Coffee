...
import farmImage from "../../assets/images/about/coffee-farm.webp";
...
const features = [
  {
    ...
    icon: <FaLeaf />,
    title: "100% Organic",
    description: "Grown without harmful chemicals using sustainable farming methods.",
  },
  {
    id: 2,
    icon: <FaSeedling />,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-zinc-400 leading-8">
              Our beans are sourced directly from trusted coffee farms
              where quality, sustainability and ethical farming are
